...
import os
if not os.path.exists('train_smoker_dataset_labeled_without_outlier.csv'):
    df.to_csv('train_smoker_dataset_labeled_without_outlier.csv', index=False)
df=pd.read_csv('train_smoker_dataset_labeled_without_outlier.csv')
